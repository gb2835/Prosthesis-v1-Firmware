...
* 2. Test programs are provided prior to main loop to test device functionality.
* 3. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
*    A new magnetic encoder bias position must be found and defined whenever the magnet is reassembled into the device.
*    A test program is provided to find the bias.
*    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
* 4. Search -> File on "* USER ADDED " will show code added to MX autogenerated files.
*
*******************************************************************************/
