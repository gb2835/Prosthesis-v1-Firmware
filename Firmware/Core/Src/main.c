...
* 3. Search -> File on "* USER ADDED " will show code added to MX autogenerated files.
* 4. CM__startProgram is a variable controlled by CubeMonitor.
*    When CubeMonitor is not being used (e.g. debugging) this value should be set to 1 (one).
*
*******************************************************************************/
...
volatile uint8_t CM__startProgram = 0;
